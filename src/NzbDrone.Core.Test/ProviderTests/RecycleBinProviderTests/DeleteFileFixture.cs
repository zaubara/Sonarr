...
namespace NzbDrone.Core.Test.ProviderTests.RecycleBinProviderTests
{
    ...
    public class DeleteFileFixture : CoreTest
    {
        ...
        public void should_use_move_when_recycleBin_is_configured()
        {
            ...
            Mocker.GetMock<IDiskTransferService>().Verify(v => v.TransferFileVerified(path, @"C:\Test\Recycle Bin\S01E01.avi".AsOsAgnostic(), TransferMode.Move), Times.Once());
        }
        ...
        public void should_use_alternative_name_if_already_exists()
        {
            ...
            Mocker.GetMock<IDiskTransferService>().Verify(v => v.TransferFileVerified(path, @"C:\Test\Recycle Bin\S01E01_2.avi".AsOsAgnostic(), TransferMode.Move), Times.Once());
        }
